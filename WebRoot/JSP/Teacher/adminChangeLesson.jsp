                 ...
                 <!-- 课程信息 -->
                    <div class="divSection">
                        <div class="divNav" style="padding-left:15px">
                            ...
                            <span><%=request.getParameter("lesson_name")%></span> 
                            <span><i class="icon-chevron-right"></i></span>
                            <span>修改课程信息</span> 
                        ...
                        <%
							 ...
							 <script>$(document).ready(function () {
							 			$("#lesson_type").val("<%=less.getLesson_type() %>");
                        ...
                        <div class="divContent">
                            <div class="row">
                                ...
                                <div class="col-xs-4 Editor"><input id="lesson_id" value=<%=less.getLesson_id() %>></div>
                                <div class="col-xs-2 Lab">课程类别</div>
                                <div class="col-xs-4 Editor"><select id="lesson_type">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10 Editor"><input id="lesson_name" value=<%=less.getLesson_name() %>></div>
                                <div class="col-xs-2 Lab">参考资料</div>
                                <div class="col-xs-10 Editor"> <input id="lesson_data" value=<%=less.getLesson_data() %>></div>
                                <div class="col-xs-2 Lab">内容简介</div>
                                <div class="col-xs-10  Editor">
                                    <textarea rows="4"  id="lesson_info"><%=less.getLesson_info() %></textarea>
                                </div>
                            </div>
                        </div>
