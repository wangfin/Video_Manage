    ...
    function upload()
		{
			...
			if(document.getElementById("video_id").value == null || document.getElementById("video_name").value == null ||
				document.getElementById("video_data").value == null || document.getElementById("video_info").value == null)
			{
				alert("请填写完整");
				}
			else
			...
			request.open("POST", "servlet/SaveServlet_video");//post方式发送，默认异步
			var data = "video_id=" + document.getElementById("video_id").value 
		                 + "&lesson_id=<%=lesson_id%>" 
		                 + "&lesson_name=<%=lesson_name%>"
		                  + "&video_name=" + document.getElementById("video_name").value
		                  + "&video_data=" + document.getElementById("video_data").value
		                  + "&video_info=" + document.getElementById("video_info").value;
                    ...
                    <div class="divSection">
                        <div class="divNav" style="padding-left:15px">
	                        ...
	                        <div class="divContent">
	                        	...
	                        	<div class="col-xs-2 Lab">选择上传视频<br><span style="color:green">(请传输mp4格式)</span></div>
	                                <!-- <input type="file"> -->
	                                <!-- 二进制流传输 -->
	                                <form action="servlet/UploadServlet_video?lesson_id=<%=request.getParameter("lesson_id")%>&lesson_name=<%=lesson_name %>" method="post" enctype="multipart/form-data">
	                            ...
	                            <div class="row">
	                                <div class="col-xs-2 Lab">视频编号</div>
	                                <div class="col-xs-4 Editor"><input type="text" id="video_id"/></div>
	                                
	                            </div>
	                            <div class="row">
	                                <div class="col-xs-2 Lab">视频名称</div>
	                                <div class="col-xs-10 Editor"><input type="text" id="video_name"/></div>
	                                <div class="col-xs-2 Lab">参考资料</div>
	                                <div class="col-xs-10 Editor"> <input type="text" id="video_data"/></div>
	                                <div class="col-xs-2 Lab">内容简介</div>
	                                <div class="col-xs-10  Editor">
	                                    <textarea rows="4"  id="video_info"></textarea>
	                                </div>
